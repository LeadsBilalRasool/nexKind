...
import { MapPin, Briefcase, Clock, Building2, ArrowLeft, Globe, Loader, CheckCircle } from 'lucide-react';
      ...
      <div className="bg-white border-b border-slate-200 py-12">
        <div className="container-custom">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            <div className="w-24 h-24 bg-blue-50 rounded-xl flex items-center justify-center text-primary font-bold text-3xl shrink-0 border border-blue-100 overflow-hidden">
              {job.image ? (
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-slate-100 rounded-lg flex items-center justify-center font-bold text-slate-500 overflow-hidden">
                {job.image ? <img src={job.image} className='w-full h-full object-contain' /> : job.company.charAt(0)}
              </div>
              <div>
