      ...
      <section className="py-10 border-y border-slate-100 bg-white">
        <div className="container-custom">
          ...
          >
            ...
            {['Google', 'Microsoft', 'Amazon', 'Spotify', 'Slack'].map((logo, i) => (
              <span key={i} className="text-2xl font-bold text-slate-400 flex items-center gap-2">
                <div className="w-8 h-8 bg-slate-200 rounded-full"></div> {logo}
              </span>
            ))}
          </motion.div>
        </div>
