            ...
            <div className="p-6 overflow-y-auto custom-scrollbar">
              <form id="scholarshipForm" onSubmit={handleSave} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <FormInput label="Deadline (e.g. May 30, 2026)" value={formData.deadline} onChange={e => setFormData({ ...formData, deadline: e.target.value })} required />
                  <FormInput label="Category (e.g. Merit-based)" value={formData.category} onChange={e => setFormData({ ...formData, category: e.target.value })} />
                </div>
